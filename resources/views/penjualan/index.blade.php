...
<section class="content p-2">
    ...
    <div class="card shadow-lg p-3 mb-4 bg-body-tertiary rounded">
      ...
      <h1 style="font-size: 40px;">Data penjualan Titipan</h1>
      </div>
      <div class="card-body">
      @if(session('success'))
      ...
      @endif
      {{-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalFormpenjualan">
        <i class="fas fa-plus"></i> Tambah Pengajuan
      </button> --}}
      {{-- <a href="{{route('penjualan.store')}}" class="btn btn-danger">
      ...
      <a href="{{ url('export/penjualan') }}" class="btn-success btn"><span> <i class="fas fa-table"></i>Export
        excel</span></a>
       --}}
      </div>
...
<script>
   ...
   $('.alert-danger').fadeTo(2000, 500).slideUp(500, function(){
    ...
    $('#editform').on('show.bs.modal', function(e){
      ...
      $('.form-edit').attr('action',`/penjualan/${id}`)
    })
