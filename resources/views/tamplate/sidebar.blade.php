<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="{{ asset('admin') }}/argon-dashboard-master/assets/img/brand/blue.png" class="navbar-brand-img" alt="...">
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="{{ asset('admin') }}/argon-dashboard-master/assets/img/theme/team-1-800x800.jpg">
              </span>
            </div>
          </a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="{{ url('jenis') }}">
              <i class="ni ni-pin-3 text-orange"></i> Jenis
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link " href="{{ url('pelanggan') }}">
              <i class="ni ni-single-02 text-yellow"></i> pelanggan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('pemesanan') }}">
              <i class="ni ni-key-25 text-info"></i> pemesanan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('stok') }}">
              <i class="ni ni-circle-08 text-pink"></i> stok
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('produk') }}">
              <i class="ni ni-circle-08 text-pink"></i> produk
            </a>
          </li>
          <li class="nav-item">
