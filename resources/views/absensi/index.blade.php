...
<section class="content p-2">
    ...
    <div class="card shadow-lg p-3 mb-4 bg-body-tertiary rounded">
      ...
      <h1 style="font-size: 40px;">Absensi</h1>
       </div>
      ...
      {{-- <a href="{{route('absensi')}}" class="btn btn-danger">
      ...
      <a href="{{ url('export/absensi') }}" class="btn-success btn"><span> <i class="fas fa-table"></i>Export
        excel</span></a>
...
<script>
   ...
   $(".btn-delete").on("click", function(e) {
    e.preventDefault() 
      let absensi = $(e.target).data('namaKaryawan')
     
      console.log(absensi)
      Swal.fire({
       icon: 'error',
       title: 'Hapus Data',
       html: `Apakah data <b>${absensi}</b> akan di hapus?`,
