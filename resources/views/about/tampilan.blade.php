  ...
  <div class="row">
      ...
      <div class="card card-profile shadow p-3 mb-5 bg-body-tertiary rounded">
        <div class="row justify-content-center">
          <div class="col-lg-3 order-lg-2">
            <div class="card-profile-image" style="padding-top: 70px;">
              <a href="#">
                <img src="nau.jpeg" class="rounded-circle">
              </a>
            </div>
          </div>
        </div>
    ...
    <div class="col-xl-8 order-xl-1">
      <div class="card bg-secondary shadow">
        ...
        <div class="card-body">
          <form>
            <h6 class="heading-small text-muted mb-4 ml-3">All sytems are running smoothly! have 2 unread alerts!</h6>
            <div class="pl-lg-4">
              <div class="row">
              ...
              <div class="row" style="margin-top: 12px;">
                <div class="card" style="width: 45rem;">
                  <div class="card-body">
                    ...
                    <h5 class="card-text">3. Laporan analitik</h5>
                  </div>
                </div>
              </div>
