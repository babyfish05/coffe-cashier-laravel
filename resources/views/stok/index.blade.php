...
<section class="content p-2">
    ...
    <div class="card shadow-lg p-3 mb-4 bg-body-tertiary rounded">
      ...
      <h1 style="font-size: 40px;">Data stok</h1>
      </div>
      <div class="card-body">
      @if(session('success'))
...
<script>
   ...
   $('.alert-danger').fadeTo(2000, 500).slideUp(500, function(){
    ...
    $('#editform').on('show.bs.modal', function(e){
      ...
      let jumlah_stok = $(button).data('jumlah_stok')
      ...
      $(this).find('#id').val(id)
      $(this).find('#jumlah_stok').val(jumlah_stok)
   ...
   $(".btn-delete").on("click", function(e) {
    e.preventDefault() 
      let stok = $(e.target).data('nama')
     
      console.log(stok)
      Swal.fire({
       icon: 'error',
       title: 'Hapus Data',
       html: `Apakah data <b>${stok}</b> akan di hapus?`,
